...
public interface Material {
     ...
     * 
     * If this is a custom material, that is not supported by the default server or client,
     * this function should return Type.CUSTOM - though it can return anything.
     * 
     * @return the base type of this Material
     */
    public Type getType();

    /**
     * The maximum size that this material can be stacked.
     * 
     * This is server dependent, and could be different to the default stack size in vanilla minecraft.
     * 
     * @return the maximum allowed stack size of this material.
     */
    ...
    public enum Type{
        ...
        private static final Map<Integer, Type> lookupId = new HashMap<Integer, Type>();
        ...
        private Type(final int id, final int stack) {
            this.id = id;
            this.maxStack = stack;
        }
